    ...
    setTimeout(() =>{
        ...
        request({url, json: true}, (error, {body}) => {
            if (error) {
                ...
                callback(undefined, body.daily.data[0].summary + " It is crurrently "+ body.currently.temperature + " degrees out. The high today is " + body.daily.data[0].temperatureHigh + " with a low of " + body.daily.data[0].temperatureLow +". There is "+ body.currently.precipProbability + "% chance of rain.")
            }
        })
    }, 0)
}
